    ...
    <div className='min-h-screen bg-white'>
      <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12'>
        ...
        <p className='text-center text-gray-600 mb-20 max-w-2xl mx-auto leading-relaxed'>
          At Tifzo, we focus on one simple mission — making food delivery safer
          and more dependable for everyone. Whether it's a Tiffin, home-cooked
          meals, snacks, or restaurant meals, we ensure hygiene, safety, and
          timely delivery. Discover how it's quickly how it may impact to
          unmatched fresh, import, and on time.
        </p>
          ...
          <div className='grid md:grid-cols-2 gap-8 items-center'>
            <div>
              <p className='text-gray-700 leading-relaxed mb-4'>
                Tifzo began with a simple vision — to solve a common problem. We
                noticed that people couldn't find a reliable, trustworthy way to
                send home-cooked meals, tiffins to their loved ones, snacks,
                sweets, and local food businesses.
              </p>
              <p className='text-gray-700 leading-relaxed mb-4'>
